                                        ...
                                        <a href={info.href} className="flex flex-col justify-between p-5 bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl border border-slate-100 dark:border-slate-800/50 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 group border-transparent hover:border-primary-500/20 h-full min-h-[140px]">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="text-xs md:text-sm font-bold text-slate-900 dark:text-white break-all tracking-tight leading-tight">{info.value}</p>
                                                </div>
                                            </div>
                    ...
                    >
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-semibold uppercase tracking-wider text-slate-400 ml-1">Email</label>
                            ...
                            <button type="submit" className="w-full py-4 bg-slate-950 dark:bg-primary-600 hover:bg-primary-650 dark:hover:bg-primary-500 text-white font-bold text-[10px] uppercase tracking-wider rounded-xl flex items-center justify-center gap-3 transition-all duration-500 hover:scale-[1.01] active:scale-[0.99] shadow-xl">
